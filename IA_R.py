...
def abstract_summary_extraction(transcription):
    response = client.chat.completions.create(
        ...
        messages=[          # There are many different possible ways of achieving similar results 
            ...
            {
                "role": "system",
                "content": "You are a highly skilled AI trained in language comprehension and summarization. I would like you to read the following text and summarize it in a text that aims to be a medical consultation note. Aim to retain the points that a doctor would from the conversation, providing a coherent and readable summary that could help another doctor understand the situation. Please avoid unnecessary details or tangential points."
            },
            {
                "role": "user",
